...
function AccountScreen() {
  ...
  const handlePress = () => {
    const appStoreUrl =
      "https://drive.google.com/drive/u/0/folders/1lhPUOJlauGjY1pVwZyZi3szU4FaURNeZ";
    ...
    <View style={styles.container}>
      ...
      {conditon === "allow" ? (
        <PermitButton
          open={true}
          handleClick={() =>
            createButtonAlert("Are you sure to close auto-permit? ")
          }
          text="Active Auto Permit"
        />
      ) : conditon === "manual" ? (
        <PermitButton
          open={false}
          handleClick={() =>
            createButtonAlert("Are you sure to open auto-permit?")
          }
          text="Inactive Auto Permit"
        />
      ) : conditon === "dead" ? (
      ...
      <View style={tw`flex mt-[-20px] flex-row`}>
        <Text
          style={{
            fontSize: 16,
            color: "#ffff",
